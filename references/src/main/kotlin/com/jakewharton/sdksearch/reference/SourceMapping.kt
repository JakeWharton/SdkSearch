...
internal val SOURCE_MAP = mapOf(
    ...
    "androidx.arch.core.executor" to SUPPORT.path("app-toolkit/runtime/src/main/java/").branch("androidx-master-dev"),
    "androidx.arch.core.executor.testing" to SUPPORT.path("app-toolkit/core-testing/src/main/java/").branch("androidx-master-dev"),
    "androidx.arch.core.util" to SUPPORT.path("app-toolkit/common/src/main/java/").branch("androidx-master-dev"),
    ...
    "androidx.recyclerview" to SUPPORT.path("recyclerview/src/main/java/").branch("androidx-master-dev"),
